...
if __name__ == "__main__":
    if run_dataset_1:
        ...
        run_time, cpu_usage, memory_usage = train_test.train_parties_4(50, [party1, party2], [server1, server2], main_server1, X_train, y_train, X_test, y_test, n_classes=3)

    elif run_dataset_2_new:
        X_train, X_test, y_train, y_test = preprocess.setup_dataframe_2(dataset_address_2)
        party_list, server_list, main_server = nodes.create_nodes(13, 2, 'binary-classification', 2, X_train, y_train)
        train_test.train_model_binary_classification(dataset_name='heart', n_epochs=20, party_list=party_list,
